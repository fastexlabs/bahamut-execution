...
func (e ExecutableData) MarshalJSON() ([]byte, error) {
	type ExecutableData struct {
		...
		TxCount        *hexutil.Uint64     `json:"transactionsCount"`
	}
	...
	enc.ActivitiesRoot = e.ActivitiesRoot
	enc.TxCount = (*hexutil.Uint64)(e.TxCount)
...
func (e *ExecutableData) UnmarshalJSON(input []byte) error {
	...
	if dec.ActivitiesRoot != nil {
		e.ActivitiesRoot = dec.ActivitiesRoot
	}
	if dec.TxCount != nil {
		e.TxCount = (*uint64)(dec.TxCount)
	}
	return nil
}
